	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i > 0; i++) {
			...
			case 1:
				...
				switch (choice2) {
				case 1:
					if (cages1.get(l).AvailableSpace() == false
							&& l == cages1Size - 1) {
						System.out.println("No space left");
						continue;
					}

					else if (cages1.get(l).AvailableSpace() == false
							&& l != cages1Size - 1) {
					...
					break;
				case 2:
					if (cages2.get(m).AvailableSpace() == false
							&& m == cages2Size - 1) {
						System.out.println("No space left");
						continue;
					} else if (cages2.get(m).AvailableSpace() == false
							&& m != cages2Size - 1) {
					...
					break;
				case 3:
					if (cages3.get(n).AvailableSpace() == false
							&& n == cages3Size - 1) {
						System.out.println("No space left");
						continue;
					}

					else if (cages3.get(n).AvailableSpace() == false
							&& n != cages3Size - 1) {
			...
			case 2:
				System.out
						.println("Enter 1 if you want to remove mammal,2 for reptile,3 for insect");
			...
			case 3:
				...
				System.out.println("NORTH ZONE has canteen: "
						+ cage1.HasCanteen());

				System.out.println("SOUTH ZONE has park: " + cage2.HasPark());
				System.out.println("SOUTH ZONE has canteen: "
						+ cage2.HasCanteen());

				System.out.println("WEST ZONE has park: " + cage3.HasPark());
				System.out.println("WEST ZONE has canteen: "
						+ cage3.HasCanteen());
